                ...
                <div class="modal-content">
                    ...
                    <form action="{{route('upload_setting')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Background Tentang</label>
                                <input type="file" class="form-control-file" name="foto_tentang">
                            </div>
                            <div class="form-group">
                                <label>Background Informasi</label>
                                <input type="file" class="form-control-file" name="foto_info">
                            </div>
                            <div class="form-group">
                                <label>Background Berita</label>
